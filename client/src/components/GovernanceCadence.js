...
function GovernanceCadence({ documents }) {
        ...
        <div className="category-modal" onClick={(e) => e.stopPropagation()} style={{maxWidth: '700px', maxHeight: '80vh', overflow: 'auto'}}>
          <div className="category-modal-header">
            <h3>
              ...
              Governance Details: {selectedGovernance['Forum / Meeting Name'] || selectedGovernance['Meeting Name'] || selectedGovernance['Meeting Type'] || selectedGovernance['Stakeholder Name'] || selectedGovernance['Name']}
            </h3>
  ...
  const filteredGovernance = governanceSearch.trim() === '' 
    ...
    : documents.governanceCadences.filter(g => {
        ...
        return (
          String(g['Forum / Meeting Name'] || g['Meeting Name'] || g['Meeting Type'] || g['Stakeholder Name'] || g['Name']).toLowerCase().includes(searchTerm) ||
            ...
            <div style={{display: 'flex', alignItems: 'center', gap: '16px', flex: 1, minWidth: 0}}>
              ...
              <div style={{minWidth: '200px', maxWidth: '320px', flex: '0 1 320px', wordBreak: 'break-word'}}>
                <div style={{fontWeight: '600', color: '#1f2937', fontSize: '14px'}}>
                  {governance['Forum / Meeting Name'] || governance['Meeting Name'] || governance['Meeting Type'] || governance['Stakeholder Name'] || governance['Name'] || 'Untitled Meeting'}
                </div>
                <div style={{color: '#6b7280', fontSize: '12px'}}>
                  {governance['Meeting Type'] || governance['Role'] || governance['Designation / Role'] || '-'}
                </div>
              </div>
