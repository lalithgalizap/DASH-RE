...
const RiskDetailModal = ({ project, onClose }) => {
        ...
        <div className="modal-body" style={{ padding: '20px' }}>
          {risks.length > 0 ? (
              ...
              <tbody>
                {risks.map((item, idx) => (
                  <tr key={idx} style={{ borderBottom: '1px solid #e5e7eb' }}>
                    ...
                    <td style={{ 
                      padding: '10px', 
                      color: item.severity?.toLowerCase() === 'critical' ? '#dc2626' : '#f59e0b', 
                      fontWeight: '500' 
                    }}>
                      {item.severity}
                    </td>
            ...
            <p style={{ textAlign: 'center', color: '#6b7280', padding: '40px' }}>
              No critical risks found for this project.
            </p>
          )}
        </div>
      </div>
