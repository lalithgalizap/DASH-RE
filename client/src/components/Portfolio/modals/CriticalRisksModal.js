...
const CriticalRisksModal = ({ isOpen, onClose, projects, selectedClient }) => {
    ...
    const fetchHistory = async () => {
      ...
      try {
        ...
        const response = await axios.get(
          `/api/metrics/history?metric=openCriticalRisksTotal&weeks=5${clientParam}`,
      ...
      return (
        <div style={{
          ...
          <p style={{ margin: '0 0 8px 0', color: '#dc2626', fontWeight: 600 }}>
            Total Critical Risks: {data.value}
          </p>
