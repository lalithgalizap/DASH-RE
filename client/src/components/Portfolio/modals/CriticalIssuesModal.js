...
const CriticalIssuesModal = ({ isOpen, onClose, projects, selectedClient }) => {
    ...
    const fetchHistory = async () => {
      ...
      try {
        ...
        const response = await axios.get(
          `/api/metrics/history?metric=openCriticalIssuesTotal&weeks=5${clientParam}`,
      ...
      return (
        <div style={{
          ...
          <p style={{ margin: '0 0 8px 0', color: '#dc2626', fontWeight: 600 }}>
            Total Critical Issues: {data.value}
          </p>
      ...
      <div className="modal-content" onClick={(e) => e.stopPropagation()} style={{ 
        ...
        <div className="modal-body" style={{ padding: '20px' }}>
          ...
          <div style={{ 
            ...
            {viewMode === 'list' && projectsWithIssues.length > 4 && (
          ...
          {viewMode === 'list' && searchTerm && (
            <div style={{ 
              ...
              Showing {filteredProjects.length} of {projectsWithIssues.length} projects
            </div>
          )}
              ...
              <div className="critical-accordion" style={{ border: 'none' }}>
                {filteredProjects.length > 0 ? (
                  ...
                  <p className="rag-summary-empty" style={{ padding: '40px 20px' }}>
                    {searchTerm ? 'No projects match your search' : 'No projects with open critical issues'}
                  </p>
                )}
              </div>
            </div>
